...
nombrePeriodesEtablissement	INT(2) COMMENT "Nombre de périodes de l’établissement",
complementAdresseEtablissement VARCHAR(38) COMMENT "Complément d’adresse",
numeroVoieEtablissement INT(4) COMMENT "Numéro de voie",
...
numeroVoie2Etablissement INT(4) COMMENT	"Numéro de la voie de l’adresse secondaire",
